...
## 4) [СВОЕВРЕМЕННАЯ КОНТРАТАКА (OPPORTUNE RIPOSTE)](https://pf2e-ru-translation.readthedocs.io/ru/latest/classes/swashbuckler.html#action-swashbuckler-opportune-riposte)
...
## 2) [ФИНИШНОЕ ПРОДОЛЖЕНИЕ (FINISHING FOLLOW-THROUGH)](https://pf2e-ru-translation.readthedocs.io/ru/latest/classes/swashbuckler.html#finishing-follow-through-2)
...
---
# Общие черты:
## 1) [ЖИВУЧЕСТЬ (TOUGHNESS) / 1](https://pf2e-ru-translation.readthedocs.io/ru/latest/feats.html#toughness-1)
Вы можете выдержать больше ударов, чем большинство. Увеличьте ваши максимальные Очки Здоровья на значение вашего уровеня. Ваш КС проверок восстановления становится равным 9 + ваше значения состояния при смерти (Проверки восстановления (Recovery Checks)).


---
# Стильные приёмы: 
## 1) [Кошачье падение (Cat Fall) / 1] (https://pf2e-ru-translation.readthedocs.io/ru/latest/feats.html#feat-cat-fall)
...
- Ломик
- Крюк-кошка
- чернила и записную книжку (немного использованная)


Судья Ханри. 
Проникновение в частный дом, сопротивление страже.
Неизвестная личность, чёрные одеяния, чёрный плащ.

А: Магазин всякой всячины (Переулок Несчастья, д.3)
Б: Площадь

Татуировка в виде Паука у того, кто напал. Также у него записка с домом.


Эни - девочка-товар.


Ночью отыграть своё презрительное отношение к Эни в виду её родства с высоким сословием. Ведь Аккар пытался быть добрым и к детям господ, но получал лишь насмешки, упрёки и отвратительное поведение.

Бежим на юго-запад города...